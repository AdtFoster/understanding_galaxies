...
BATCH_GAL_MIN=2500      #if running over multiple nodes, would increase as [0, 2500, 5000, 7500, 10000, 12500, 15000, 17500, 20000, 22500]
BATCH_GAL_MAX=5000   #if running over multiple nodes, would increase as [2500, 5000, 7500, 10000, 12500, 15000, 17500, 20000, 22500, :]
