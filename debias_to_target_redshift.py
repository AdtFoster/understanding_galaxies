...
if __name__ == '__main__':
    ...
    delta_z = args.min_delta_z
    delta_p = args.initial_delta_p
    delta_mag = args.initial_delta_mag
    ...
    residual_array, count_array_perm, error_array_perm, standard_deviation_array = optimise(delta_z, delta_p, delta_mag, delta_mass, delta_conc, standard_deviation_array, residual_array, count_array_perm, error_array_perm, count)
